...
abstract class IP {
  ...
  static const String utem = "10.131.78.207/Bolt-API";
    static const String pc = "192.168.0.58/Bolt-API";
    static const String domain = "boltapi.free.nf/Bolt-API/";

}

// Make this public (remove underscore) so it can be imported
const String activeIP = IP.utem;  // Now using 'other